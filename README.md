...
El dataset principal (~1,45M de registros, 2020-2024) procede del
[Chicago Data Portal — Crimes 2001 to present](https://data.cityofchicago.org/Public-Safety/Crimes-2001-to-Present/ijzp-q8t2).
Por su tamaño, no se incluye en el repositorio. Para reproducir el análisis:
...
2. Guárdalo como `data/Proyecto_Bootcamp.csv`.
3. Las variables socioeconómicas por *Community Area* (población, renta per cápita, tasa de
   desempleo, tasa de pobreza, nivel educativo) se obtuvieron de fuentes públicas del
   [Chicago Health Atlas](https://chicagohealthatlas.org/) y deben guardarse como
   `data/Variables_socioeconomicas.xlsx`.
